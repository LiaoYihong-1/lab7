...
public class CommandPackage implements Serializable {
    ...
    CommandPackage(String[] arg, AbstractCommand command) {
        this.arg = arg;
    ...
    CommandPackage(AbstractCommand command, Person people) {
        this.P = people;
        this.arg = null;
        this.abstractCommand = command;
        this.linkedHashSet = null;
    ...
    CommandPackage(String[] S, AbstractCommand command, Person P) {
        this.arg = S;
        this.P = P;
        this.abstractCommand = command;
        this.linkedHashSet = null;
